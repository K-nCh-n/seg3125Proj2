    ...
    <Container fluid="xxl" className="my-2 py-2 bg-light" id="background-container">
      <Row>
            ...
            <Card.ImgOverlay className="card-img-overlay text-center">
              ...
              <Card.Footer className="bg-transparent border-0">
                <div className="position-absolute bottom-0 mb-5 w-100 start-0">
                  <Link to="/membership" className="btn btn-primary rounded-pill px-3 py-2 mx-3">Member Portal</Link>
                  <Link to="/book" className="btn btn-success rounded-pill px-3 py-2 mx-3">Book</Link>
                </div>
              </Card.Footer>
            </Card.ImgOverlay>
          </Card>
        ...
        <Col lg="4" className="bg-light d-lg-flex flex-column">
          ...
          <div>
            <h3 className="mt-3 fw-bold">Opening Hours</h3>
            <Row>
              <Col>
